...
Isomap_SVR_y_predict = dict()
Isomap_SVR_y_test = dict()
...
file = path + "\\Isomap_Dimension_Reduction_Isomap_SVR.txt"
...
with open(file, "w+") as f:
    ...
    for i_value in np.arange(Isomap_SVR_accuracy_i_value):
        ...
        temp_mean = np.mean(Isomap_SVR_accuracy[index]) * (-1)
